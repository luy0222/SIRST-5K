...
image_Path_1 = 'Demos/mix/images0.1'
image_Path_2 = 'Demos/mix/images0.2'
image_Path_3 = 'Demos/mix/images0.3'
image_Path_4 = 'Demos/mix/images0.4'
image_Path_5 = 'Demos/mix/images0.5'

save_Path_1 = 'Demos/output/3_images0.1'
save_Path_2 = 'Demos/output/3_images0.2'
save_Path_3 = 'Demos/output/3_images0.3'
save_Path_4 = 'Demos/output/3_images0.4'
save_Path_5 = 'Demos/output/3_images0.5'
...
with open('coordinates.txt', 'r') as file:
    file = file.readlines()
    imgNames_l = os.listdir(image_Path_0)
    ...
    for line in file:
        for img in imgNames_s:
            if file.index(line) == imgNames_s.index(img):
                ...
                for j in str_list:
                    for k in range(4):
                            rot_patch_3(os.path.join(save_Path_1),
                            ...
                            rot_patch_3(os.path.join(save_Path_2),
                                        os.path.join(image_Path_2, "{}.png".format(imgNames_s[imgNames_s.index(img)])),
                                        str_list[str_list.index(j)], k,str_list.index(j))
                            print('save image', imgNames_s[imgNames_s.index(img)], save_Path_2)
                            rot_patch_3(os.path.join(save_Path_3),
                                        os.path.join(image_Path_3, "{}.png".format(imgNames_s[imgNames_s.index(img)])),
                                        str_list[str_list.index(j)], k,str_list.index(j))
                            print('save image',imgNames_s[imgNames_s.index(img)],save_Path_3)
                            rot_patch_3(os.path.join(save_Path_4),
                                         os.path.join(image_Path_4, "{}.png".format(imgNames_s[imgNames_s.index(img)])),
                                         str_list[str_list.index(j)], k, str_list.index(j))
                            print('save image', imgNames_s[imgNames_s.index(img)], save_Path_4)
                            rot_patch_3(os.path.join(save_Path_5),
                                         os.path.join(image_Path_5, "{}.png".format(imgNames_s[imgNames_s.index(img)])),
                                         str_list[str_list.index(j)], k, str_list.index(j))
                            print('save image', imgNames_s[imgNames_s.index(img)], save_Path_5)
