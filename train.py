...
class Trainer(object):
    def __init__(self, args):
        ...
        self.writer = SummaryWriter(os.path.join(root,'{}_{}_{}'.format(args.dataset,args.epochs,args.backbone)))
    ...
    def testing (self, epoch):
        ...
        # Log training and testing loss values to TensorBoard

        self.writer.add_scalar('Training Loss', self.train_loss, epoch)
        self.writer.add_scalar('Test Loss', test_loss, epoch)
        self.writer.add_scalar('Mean IoU', mean_IOU, epoch)
        #self.writer.add_scalar('ROC',precision,recall)
